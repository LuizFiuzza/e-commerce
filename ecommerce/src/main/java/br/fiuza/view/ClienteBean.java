...
public class ClienteBean implements Serializable
{
   ...
   private Predicate[] getSearchPredicates(Root<Cliente> root)
   {
      ...
      {
         predicatesList.add(builder.like(builder.lower(root.<String> get("cpf")), '%' + cpf.toLowerCase() + '%'));
      }
      ...
      String end = this.example.getEnd();
      if (end != null && !"".equals(end))
      {
         predicatesList.add(builder.like(builder.lower(root.<String> get("end")), '%' + end.toLowerCase() + '%'));
      }
      String telefone = this.example.getTelefone();
      if (telefone != null && !"".equals(telefone))
      {
         predicatesList.add(builder.like(builder.lower(root.<String> get("telefone")), '%' + telefone.toLowerCase() + '%'));
      }
